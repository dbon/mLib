...
public class Configuration {
  public static final String configurationFileName = "configuration.ini";
  public static final String configurationKeyDatabaseLocation = "database.location";
  public static final String defaultDatabaseFile = "mediaLib.sqlite";
  public static String scanDir = null;
  public static final String configurationKeyScanDir = "scan.dir";
  public static final String sqliteTable = "mediaLib";
